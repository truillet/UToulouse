...
* code java+python utilisant ivy pouur la reconnaissance et synthèse vocale : **[dessert]**(https://github.com/truillet/UToulouse/blob/master/m2ihm/TP/dessert.zip)
